...
class HelpWindow(QWidget):
    ...
    def __init__(self: Self, parent: QWidget) -> Self:
        ...
        # text view
        self.__document_view = QTextBrowser()
        self.__document_view.setProperty("role", "text_display")
        doc = QTextDocument()
        doc.setMarkdown(self.HELP_MD)
        self.__document_view.setDocument(doc)
        self.__document_view.setOpenExternalLinks(True)
        self.__document_view.setVerticalScrollBarPolicy(Qt.ScrollBarPolicy.ScrollBarAlwaysOn)
        self.__layout.addWidget(self.__document_view)
